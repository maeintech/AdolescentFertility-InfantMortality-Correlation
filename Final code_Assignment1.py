...
US_data.columns = header  # make the indicators the header for the DataFrame
...
# Investigate the correlation between infant mortality and adolescent fertility
...
x = np.arange(2010, 2021, 1, dtype=int)  # values for x-axis

mortality = Sudan_data.loc["2010":"2020",
                           'Mortality rate, infant (per 1,000 live births)']
y1 = mortality.values  # values for y-axis on first bar chart

fertility = Sudan_data.loc[
            "2010":"2020",
...
y1_title = "Mortality rate of infants in Sudan (2010 - 2020)"

y2_xlabel = "Years"
y2_ylabel = 'Adolescent fertility rate (births per 1,000 women ages 15-19)'
y2_title = "Adolescent fertility rate in Sudan (2010 - 2020)"
...
# child bearing age in Sudan (for year 2010 and 2020)
x = Sudan_data
y1 = "2010"
...
# child bearing age in 2010 and 2020
female_pop1 = np.array([a, b, c, d, e, f])  # for year 2010
female_pop2 = np.array([g, h, i, j, k, l])  # for year 2020
...
def subplot_pie(p1, p2):
    ...
    plt.legend(labels=label, loc='lower right', title=title_legend,
               bbox_to_anchor=(1.3, -0.1))  # legend for both charts
    return fig
...
title1 = "Percentage of Female population of Child-Bearing age (Sudan, 2010)"
title2 = "Percentage of Female population of Child-Bearing age (Sudan, 2020)"
